...
1. **Study** the concept thoroughly
2. **Implement** it with realistic, production-like data
3. **Test** different scenarios and edge cases
4. **Document** insights in `notes/learnings.md`:
   - What made sense (breakthroughs)
